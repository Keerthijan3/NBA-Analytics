'''
This script will be used to evaluate how nba players' skillset has changed
over the years for different positions
The script must be passed a position (C, SG, SF, PF, PG). It will output
plots showing the evolution of player playstyles over the years.
